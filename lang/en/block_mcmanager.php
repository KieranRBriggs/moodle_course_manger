...
$string['newrequest'] = 'Make New Request';
$string['managerequests'] = 'Manage My Requests';
$string['queue'] = 'Course Requests';
$string['pending'] = 'Pending';
$string['archive'] = 'Archive';
$string['mcmanagerDisplay'] = 'My Requests';
$string['queue'] = 'New Requests';
$string['backtomymoodle'] = 'Back to myMoodle';
$string['noarchivedcourses'] = 'No Archived Courses to View';

//Settings Page Lang strings
...
$string['extraebscode'] = 'Other Connected EBS Codes';
